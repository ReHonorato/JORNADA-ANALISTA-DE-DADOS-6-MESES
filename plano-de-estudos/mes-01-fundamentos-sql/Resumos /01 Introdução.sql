...
São registros soltos de algo. De forma bruta eles não significam nada.

Um exemplo simples; se encontrassemos varias peças de um quebra-cabeça, seria impossivel de adivinhar qual a imagem so de olhar pra eles. Os dados brutos são dessa forma, a amenos que eles sejam organizados não podemos fazer uma leitura de informação. Os dados so passam a ter significado quando estão organizados.

-- ==================================================================================
-- ETAPAS E FERRRAMENTAS
-- ==================================================================================

COLETA = os dados estão armazenados de diversas formas, por exemplo: eles podem estar em planilhas do excel, podem estar em banco de dados de sistemas ou em arquivos CSV. Para coletar vamos usar o Excel, consultas com SQL ou Python.

LIMPEZA = _ Os dados sempre vem com erros, campos vazios e duplicidades. Para resolver isso podemos usar as seguintes ferramentas:
...
Sql -> juntar tabema e criar visões organizadas. 
Excel ->separação pcriar novas colunas, agrupar dadosor categoria 
Python -> criar no bovas tabelas, agrupar dados reorganizar tabelas
...
INSIGHTS = é aqui demosntramos o que vai acontecer e quais as melhores decisões a tomar
